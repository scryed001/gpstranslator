...
//						tzi.DaylightDate = tzr.DaylightDate;
		...
		[DllImport("citydb")]
		extern static void InitCityDb();
		
		[DllImport("citydb")]
		extern static void UninitCityDb();

		[DllImport("citydb")]
		extern static int ClockGetNumTimezones();

		[DllImport("citydb")]
		extern static void ClockLoadAllTimeZoneData();
		[DllImport("citydb")]
		extern static void ClockFreeAllTimeZoneData();

		[DllImport("citydb")]
		extern static IntPtr ClockGetTimeZoneDataByOffset(int nOffset);
		[DllImport("citydb")]
		extern static IntPtr ClockGetTimeZoneData(int nOffset);
