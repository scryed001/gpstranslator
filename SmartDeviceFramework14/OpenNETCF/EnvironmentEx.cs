	...
	public sealed class EnvironmentEx
	{
		...
		public static string OemInfo
		{
			get
			{
				...
				//call native function
				if(!OpenNETCF.Win32.Core.SystemParametersInfo(Core.SystemParametersInfoAction.GetOemInfo, buffer.Length, buffer, Core.SystemParametersInfoFlags.None))
				{
		...
		public static long WorkingSet
		{
			get
			{
				...
				return Convert.ToInt64(OpenNETCF.Win32.Core.GlobalMemoryStatus().AvailablePhysical);
			}
		}
		#endregion
