	...
	public class DecodeCertKey
	{
		...
		public static void GetPublicRsaParams(X509Certificate cert, out byte[] exponent, out byte[] modulus)
		{
			...
			*/
			...
			IntPtr buffer = OpenNETCF.Security.Cryptography.NativeMethods.Mem.AllocHGlobal( headerslength);
			...
			OpenNETCF.Security.Cryptography.NativeMethods.Mem.FreeHGlobal( buffer );
