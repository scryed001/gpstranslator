...
namespace OpenNETCF.Web.Services2
{
	public class MimeType
	{
		...
		[CLSCompliant(false)]
		public const string _323 = "text/h323";
		...
		public const string pmc = "application/x-perform";
		...
		public const string stl = "application/vndms-pkistl";
		...
		[CLSCompliant(false)]
		public const string _star = "application/octet-stream"; //*
		...
		public const string xlt = "application/vnd.mx-excel";
		...
		public const string pml = "application/x-perform";
		...
		public const string m14 = "application/x-msmdeiaview";
		...
		public const string sst = "application/vndms-pkicertstore";
		public const string pko = "application/vndms-pkipko";
		...
		public const string cat = "application/vndms-pkiseccat";
		...
		public const string rmi = "audio/x-pn-realaudio";
