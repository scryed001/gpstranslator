...
namespace GPSProxy
{
	...
	public class FormMain : System.Windows.Forms.Form, IApplication, IMessageFilter
	{
        ...
        private OpenNETCF.Threading.EventWaitHandle wakeupEvent = new OpenNETCF.Threading.EventWaitHandle(false, OpenNETCF.Threading.EventResetMode.AutoReset, wakeupEventName);
		...
		{
            // There will exception if the application icon is empty.
