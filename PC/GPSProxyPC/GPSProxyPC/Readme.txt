...
The content of app.config will be copied to GPSProxyPC.exe.config after building, which will be used by GPSProxy.SerialPort to configure the web service client. So configure the service or update the end point in the app.config of the GPSProxy.SerialPort doesn't work.
