...
namespace OpenNETCF.Windows.Forms
{
	...
	public class MonthCalendar : ControlEx
	{
		...
		public bool ShowNone
		{
			...
			{
#if !DESIGN
				return (Win32Window.GetWindowLong(this.ChildHandle, (int)GWL.STYLE) & (int)MCS.SHOWNONE) == (int)MCS.SHOWNONE;
#else
				return false;
#endif
			}
		...
		public bool ShowToday
		{
			...
			{
#if !DESIGN
				return (Win32Window.GetWindowLong(this.ChildHandle, (int)GWL.STYLE) & (int)MCS.NOTODAY) != (int)MCS.NOTODAY;
#else
				return false;
#endif
			}
		...
		public bool ShowTodayCircle
		{
			...
			{
#if !DESIGN
				return (Win32Window.GetWindowLong(this.ChildHandle, (int)GWL.STYLE) & (int)MCS.NOTODAYCIRCLE) != (int)MCS.NOTODAYCIRCLE;
#else
				return false;
#endif
			}
		...
		public bool ShowWeekNumbers
		{
			...
			{
#if !DESIGN
				return (Win32Window.GetWindowLong(this.ChildHandle, (int)GWL.STYLE) & (int)MCS.WEEKNUMBERS) == (int)MCS.WEEKNUMBERS;
#else
				return false;
#endif
			}
